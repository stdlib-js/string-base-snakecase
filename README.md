...
```javascript
import snakecase from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-snakecase@v0.2.3-esm/index.mjs';
```
...
[@stdlib/string/base/stickycase]: https://github.com/stdlib-js/string-base-stickycase/tree/esm
